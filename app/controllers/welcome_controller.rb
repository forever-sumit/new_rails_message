class WelcomeController < ApplicationController
  ...
  def check_passcode
    if @contact.passcode == params[:passcode]
      @contact.update_attribute(:attempt_count, 0)
      ...
      attempt_count = @contact.attempt_count.blank? ? 0 : @contact.attempt_count + 1
      @contact.update_attribute(:attempt_count, attempt_count)
